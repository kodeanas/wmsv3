...
export default function UploadSKUPage() {
	...
	const handleUpload = () => {
		// TODO: Ganti dengan flow upload SKU yang sebenarnya.
		...
		<div className="space-y-6">
			<form className="space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
				<div className="mb-4 flex items-center justify-between">
					<h2 className="text-xl font-bold text-slate-800">Upload SKU</h2>
				</div>
