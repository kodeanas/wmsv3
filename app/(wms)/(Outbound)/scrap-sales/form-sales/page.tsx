...
const buyers: BuyerOption[] = [
  { id: "BUY-021", name: "PT Recycle Sentosa" },
  { id: "BUY-022", name: "CV Besi Lama" },
  { id: "BUY-023", name: "UD Barang Sisa" },
];

const bagOptions: BagOption[] = [
  { id: "SCR-BAG-01", name: "Bag Scrap Mix", hargaAsal: 980000 },
  { id: "SCR-BAG-02", name: "Bag Scrap Besi", hargaAsal: 1230000 },
  { id: "SCR-BAG-03", name: "Bag Scrap Tekstil", hargaAsal: 860000 },
];

const formatRupiah = (value: number) =>
  `Rp ${Math.max(0, value).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")}`;

export default function ScrapFormSalesPage() {
  ...
  const handleFinishSales = () => {
    ...
    console.log("Finish Scrap Sales", {
  ...
  return (
    <div className="space-y-6 pb-10">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold text-slate-800">Form Penjualan Scrap</h1>
      </div>
