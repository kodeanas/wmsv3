...
const bagData = [
  {
    code_bag: "QCD-BAG-001",
    total_item: 120,
    total_harga_gudang: 4850000,
    status: "open",
  },
  {
    code_bag: "QCD-BAG-002",
    total_item: 80,
    total_harga_gudang: 3275000,
    status: "close",
  },
  {
    code_bag: "QCD-BAG-003",
    total_item: 95,
...
export default function BagQcdPage() {
...
<section>
        <CardKeyValueHorizontal
          ...
          items={[
            { label: "Total Bag", value: qcdBagInfo.totalBag },
            {
              label: "Total Harga Asal",
              value: formatRupiah(qcdBagInfo.totalHargaAsal),
            },
          ]}
        />
      </section>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm leading-relaxed text-slate-600">
            Bag baru akan dibuat dari data bag QCD saat ini.
          </p>
          <p className="text-sm leading-relaxed text-slate-600">
