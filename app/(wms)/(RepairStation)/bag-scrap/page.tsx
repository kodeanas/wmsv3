...
const bagData = [
  {
    code_bag: "SCRAP-BAG-001",
    total_item: 120,
    total_harga_gudang: 4850000,
    status: "open",
  },
  {
    code_bag: "SCRAP-BAG-002",
    total_item: 80,
    total_harga_gudang: 3275000,
    status: "close",
  },
  {
    code_bag: "SCRAP-BAG-003",
    total_item: 95,
...
export default function BagScrapPage() {
...
<section>
        <CardKeyValueHorizontal
          title="Info Bag Scrap"
          icon={<PackageSearch className="h-5 w-5" />}
          items={[
            { label: "Total Bag", value: scrapBagInfo.totalBag },
            {
              label: "Total Harga Asal",
              value: formatRupiah(scrapBagInfo.totalHargaAsal),
            },
          ]}
        />
      </section>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm leading-relaxed text-slate-600">
            Bag baru akan dibuat dari data bag scrap saat ini.
          </p>
          <p className="text-sm leading-relaxed text-slate-600">
