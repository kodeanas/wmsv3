...
export default function DetailBagBklPage() {
	const [tableItems, setTableItems] = useState(initialBagItems);
	const [isEditStatusModalOpen, setIsEditStatusModalOpen] = useState(false);
	const [bagStatus, setBagStatus] = useState(detailBagBkl.status);
...
<section>
				<ScannerCard
					title="Scan Item Bag BKL"
					placeholder="Scan barcode item bag BKL..."
			...
			>
				<div className="space-y-4">
					<p className="text-sm leading-relaxed text-slate-600">
						Pilih status terbaru untuk bag BKL ini.
					</p>
